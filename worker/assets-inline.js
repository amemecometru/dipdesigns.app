...
<head>
  ...
  <title>Flash Dashboard — DipDesigns</title>
...
<body class="glz-body">
  ...
  <div class="app">
    ...
    <header class="topbar">
      <div class="brand"><span class="badge glz-surface-metal"><span class="glz-node-dot"></span></span> DipDesigns</div>
      <span class="sep"></span>
  ...
  var SIGNALS = [
    ...
    { id:'s2', src:'✉', kind:'email',   title:'dashboard@ → analytics layout', status:'new', when:'12m ago',
      payload:{ source:'email', from:'dashboard@dipdesigns.app', subject:'analytics layout', prompt:'analytics dashboard with sidebar + 4 stat cards + line chart', status:'queued' } },
...
(function(){
  ...
  if(handoffGenBtn) handoffGenBtn.addEventListener('click', function(){
    ...
    md += '## Generated CSS\\n\\n\`\`\`css\\n' + (result.css || '') + '\\n\`\`\`\\n\\n';
    md += '## Generated JS\\n\\n\`\`\`javascript\\n' + (result.js || '') + '\\n\`\`\`\\n\\n';
    md += '---\\n\\n*Generated by [DipDesigns Studio](https://workers.dipdesigns.app)*\\n';
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>DipDesigns — build anywhere, bridge to production</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700;800;900&family=Space+Mono:wght@400;700&display=swap" rel="stylesheet">
...
<body class="glz-body">
  ...
  <div class="page">
    ...
    <section class="hero wrap">
      ...
      <p class="sub">DipDesigns turns plain English into live, working UI — from your phone or your desk. Then, at export, it hands you a <strong>portable backend blueprint</strong> to make it real in the stack you already use. No lock-in. No copy-paste. No mockup graveyard.</p>
      <div class="cta-row">
    ...
    <section class="band wrap" id="how">
      <div class="sec-head">
        ...
        <p>DipDesigns carries your build across both bridges — to your desk, and into production.</p>
      </div>
      <div class="steps">
    ...
    <section class="band wrap" id="ship">
      <div class="wedge2">
        <div class="wedge2-copy">
          ...
          <p>Every other tool hands you a gorgeous mockup and leaves you at the cliff. At export, DipDesigns generates a <strong>portable backend blueprint</strong> for the exact UI you built — data model, endpoints, auth, and a <span class="tl">wire-up map</span> binding every control to the endpoint it needs.</p>
    ...
    <section class="band wrap" id="why">
      <div class="sec-head"><span class="glz-label-mono">why dipdesigns</span><h2>Others lock you in. We bridge you out.</h2></div>
      <div class="why">
        <div class="pts">
    ...
    <footer>
      <div class="brand"><span class="badge glz-surface-metal" style="width:26px;height:26px;border-radius:8px;"><span class="glz-node-dot" style="width:7px;height:7px;"></span></span> DipDesigns</div>
