  ...
  try {
    ...
    const stripeRes = await fetch(CONFIG.STRIPE_API + '/checkout/sessions', {
      ...
      body: new URLSearchParams({
        ...
        'success_url': 'https://webhooks-email.logiclemonai.workers.dev/?checkout=success&session_id={CHECKOUT_SESSION_ID}',
        'cancel_url': 'https://webhooks-email.logiclemonai.workers.dev/?checkout=cancel',
